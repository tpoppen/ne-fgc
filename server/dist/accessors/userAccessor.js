...
const fetchUser = async (fetchParams) => {
    const dbClient = dynamoDbClientProvider.getClient();
    ...
    try {
        console.log({ userId: fetchParams.userId });
...
const updateUser = async (updateParams) => {
    const dbClient = dynamoDbClientProvider.getClient();
...
const updateUserPermissions = async (updatePermissionsParams) => {
    const dbClient = dynamoDbClientProvider.getClient();
    const updateUser = new UpdateItemCommand({
        TableName: getTableName(),
        Key: {
...
export { fetchUsers, fetchUser, createUser, updateUser, updateUserPermissions, deleteUser, };
